...
1. **Read the gaps list** from `/Users/dan/Projects/bidme/Auto Run Docs/LOOP_00001_GAPS.md`
2. **Rate each gap** for user importance and fix effort
3. **Assign status** based on ratings
4. **Output prioritized plan** to `/Users/dan/Projects/bidme/Auto Run Docs/LOOP_00001_PLAN.md`
...
Create/update `/Users/dan/Projects/bidme/Auto Run Docs/LOOP_00001_PLAN.md` with:
...
1. You've read `/Users/dan/Projects/bidme/Auto Run Docs/LOOP_00001_GAPS.md`
2. You've evaluated gaps with importance and effort ratings
3. You've output the prioritized plan to `/Users/dan/Projects/bidme/Auto Run Docs/LOOP_00001_PLAN.md`
