...
1. **Read the README.md** at `/Users/dan/Projects/bidme/README.md` (or `/Users/dan/Projects/bidme/readme.md`)
...
4. **Output report** to `/Users/dan/Projects/bidme/Auto Run Docs/LOOP_00001_FEATURE_INVENTORY.md`

## Analysis Checklist

- [ ] **Discover features and scan README (if needed)**: *(Completed 2026-02-05 — inventory at `Auto Run Docs/LOOP_00001_FEATURE_INVENTORY.md` with 16 documented + 38 code features, 10 gaps, 1 stale)* First check if `/Users/dan/Projects/bidme/Auto Run Docs/LOOP_00001_FEATURE_INVENTORY.md` already exists with feature data (at least one feature listed in either "Features Documented in README" or "Features Found in Code" tables). If it does, skip the survey and mark this task complete—the feature inventory is already in place. If it doesn't exist, read the project's README.md to extract what features are currently documented. Survey the codebase (entry points, CLI commands, API endpoints, UI components, configuration options) to identify actual user-facing features. Output a feature inventory to `/Users/dan/Projects/bidme/Auto Run Docs/LOOP_00001_FEATURE_INVENTORY.md`.
...
Create/update `/Users/dan/Projects/bidme/Auto Run Docs/LOOP_00001_FEATURE_INVENTORY.md` with:
