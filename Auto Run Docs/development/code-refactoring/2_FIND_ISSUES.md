...
Execute ONE tactic from `/Users/dan/Projects/bidme/Auto Run Docs/LOOP_00001_GAME_PLAN.md` to find specific refactoring candidates. Output findings to `/Users/dan/Projects/bidme/Auto Run Docs/LOOP_00001_CANDIDATES.md`.

## Instructions

1. **Read `/Users/dan/Projects/bidme/Auto Run Docs/LOOP_00001_GAME_PLAN.md`** to see available investigation tactics
2. **Read `/Users/dan/Projects/bidme/Auto Run Docs/LOOP_00001_CANDIDATES.md`** (if it exists) to see which tactics have already been executed
3. **Select ONE unexecuted tactic** from the game plan
4. **Execute the tactic**: Search the codebase using the specified patterns
5. **Document findings** in `/Users/dan/Projects/bidme/Auto Run Docs/LOOP_00001_CANDIDATES.md`
...
Append to `/Users/dan/Projects/bidme/Auto Run Docs/LOOP_00001_CANDIDATES.md` using this format:
...
- **Mark as executed**: Update `/Users/dan/Projects/bidme/Auto Run Docs/LOOP_00001_GAME_PLAN.md` to show which tactics have been run (add `[EXECUTED]` prefix)
...
2. You've appended all findings to `/Users/dan/Projects/bidme/Auto Run Docs/LOOP_00001_CANDIDATES.md`
3. You've marked the tactic as `[EXECUTED]` in `/Users/dan/Projects/bidme/Auto Run Docs/LOOP_00001_GAME_PLAN.md`

**Option B - All tactics exhausted:**
1. All tactics in the game plan are already marked as `[EXECUTED]`
2. You've appended `## ALL_TACTICS_EXHAUSTED` to `/Users/dan/Projects/bidme/Auto Run Docs/LOOP_00001_CANDIDATES.md`
